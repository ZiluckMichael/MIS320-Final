...
(
    invoice_status_id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    name              VARCHAR2(24) NOT NULL
);
...
(
    ...
    reservation_id    NUMBER                 NOT NULL REFERENCES reservation (reservation_id),
    invoice_status_id NUMBER                 NOT NULL REFERENCES invoice_status (invoice_status_id),
    notes             VARCHAR2(156)          NULL
);

CREATE TABLE invoice_payment
(
    invoice_payment_id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    payment_date       DATE         NOT NULL,
    payment_amount     NUMBER(*, 2) NOT NULL,
    invoice_id         NUMBER       NOT NULL REFERENCES invoice (invoice_id),
    payment_card_id    NUMBER       NOT NULL REFERENCES payment_card (payment_card_id)
);
