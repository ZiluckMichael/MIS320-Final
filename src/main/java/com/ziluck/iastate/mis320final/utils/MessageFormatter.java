...
final public class MessageFormatter {
     ...
     * @param messagePattern The message pattern which will be parsed and
     *                       formatted
     * @param arg1           The argument to be substituted in place of the
     *                       first formatting anchor
     * @param arg2           The argument to be substituted in place of the
     *                       second formatting anchor
     * @return The formatted message
     */
    ...
    private static void safeObjectAppend(StringBuilder sbuf, Object o) {
        try {
            ...
            LoggerUtil.report("SLF4J: Failed toString() invocation on an object of type [" + o.getClass().getName() + "]", t);
